...
public class LrbnLogin extends JFrame implements ActionListener{
	JButton b1;
	JLabel l1,l2,back;
	JTextField t1;
	JPasswordField t2;
	Font f;
	public LrbnLogin(String s){
		super(s);
		setLayout(null);
		...
		back=new JLabel(new ImageIcon("images/22.jpg"));
	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource()==b1){
			...
			try{
				...
				ResultSet rs=st.executeQuery("select * from librarian where email='"+email+"'");
				if(rs.next()){
